...
| Cycle commits | `facade_commits.go` | `facade_commits_test.go` | `internal/commits` | `UpsertCycleCommits`, `ListCommitsForCycle`. Worker-indexed SHAs after execute ingest — [docs/domain/cycle-commits.md](../../docs/domain/cycle-commits.md). |
