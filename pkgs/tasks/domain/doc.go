...
//
// Persistence is implemented in package store (github.com/AlexsanderHamir/Hamix/pkgs/tasks/store).
// HTTP routes in package handler (github.com/AlexsanderHamir/Hamix/pkgs/tasks/handler).
// Open database pool and AutoMigrate in package postgres (github.com/AlexsanderHamir/Hamix/pkgs/tasks/postgres).
//
// Tests for enum scanning live in sqltypes_test.go. See the parent module path
// github.com/AlexsanderHamir/Hamix/pkgs/tasks for a full subsystem overview.
package domain
