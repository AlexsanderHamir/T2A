...
// belonging to an execution cycle. Rows are upserted after a successful
// execute phase (before CompletePhase) from git ancestry
// cycle_base_sha..HEAD. See ADR-0014 and docs/domain/cycle-commits.md.
//
