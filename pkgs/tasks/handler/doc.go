...
// User task agent queue: handler.go (optional WithUserTaskAgentNotifier; T2A_USER_TASK_AGENT_QUEUE_CAP / reconcile env in docs/DESIGN.md; pkgs/agents). Queue consumers must AckAfterRecv or Receive so reconcile matches the buffer.
