...
// WithRecovery, WithHTTPMetrics, WithAccessLog, WithRateLimit, WithMaxRequestBody, and WithIdempotency; GET /metrics (Prometheus text) is registered separately on the mux.
//
// Flags (see also -h):
//
