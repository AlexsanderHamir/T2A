...
| `HAMIX_BROWSE_ROOTS` | — | Comma-separated absolute paths. When set, **replaces** all default picker roots (install, home, and OS user folders). For CI or restricted deployments. |
